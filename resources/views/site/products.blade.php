                        ...
                        <form method="GET" action="{{ route('filtered.products') }}" class="row g-3 align-items-center">
                            ...
                            <div class="col-md-2 mb-2">
                                <select name="discount" id="discount" class="form-select select2">
                                    ...
                                    <option value="1" {{ request('discount') === '1' ? 'selected' : '' }}>On Discount
                                    </option>
                                    <option value="0" {{ request('discount') === '0' ? 'selected' : '' }}>No Discount
                                    </option>
                                </select>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3 d-flex">
                        <div class="product ftco-animate">
                            ...
                            <div class="text text-center">
                                @if (
                                    ($product->discount > 0 && $product->discount_end === null) ||
                                        ($product->discount > 0 && \Carbon\Carbon::now()->lessThanOrEqualTo($product->discount_end)))
                                    <span class="sale">{{ $product->discount }}% Off</span>
                                    <p class="mb-0">
                                        <span class="price price-sale">${{ number_format($product->price, 2) }}</span>
                                        <span
                                            class="price">${{ number_format($product->price * (1 - $product->discount / 100), 2) }}</span>
                                    </p>
                                @else
                                    <p class="mb-0">
