...
@section('body')
    ...
    <div class="container-fluid">
        ...
        <table id="userstable" class="display responsive border text-center small">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Name</th>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm" role="group">
                                ...
                                <button type="button" class="btn btn-danger" data-toggle="modal"
                                    data-target="#deleteModal{{ $user->id }}" title="Delete"
                                    @if (
                                        $user->id === auth()->id() ||
                                            ($user->isAdmin() && \App\Models\User::where('role', 'admin')->count() <= 1) ||
                                            ($user->isDelivery() && \App\Models\User::where('role', 'delivery')->count() <= 1)) disabled @endif>
