            ...
            <div class="card-body" id="printableArea">
                <div class="row g-3">
                    <div class="col-12">
                        <!-- Order Details -->
                        <div class="row">
                            <div class="col-6 col-md-4 fw-bold">Order ID:</div>
                            <div class="col-6 col-md-8">{{ $order->id }}</div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-6 col-md-4 fw-bold">Email:</div>
                            <div class="col-6 col-md-8">{{ $order->user->email ?? 'N/A' }}</div>
                        </div>
                        <div class="row">
                            <div class="col-6 col-md-4 fw-bold">Total Price:</div>
                            <div class="col-6 col-md-8 text-success fw-bold">${{ number_format($order->total_price, 2) }}
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6 col-md-4 fw-bold">Payment Method:</div>
                            <div class="col-6 col-md-8">{{ optional($order->payment)->payment_method ?? 'N/A' }}</div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-6 col-md-4 fw-bold">Created At:</div>
                    ...
                    <div class="list-group">
                        @foreach ($order->orderItems as $item)
                            <div class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <div class="text-success fw-bold">${{ number_format($item->quantity * $item->price, 2) }}
                                </div>
                            </div>
                        @endforeach
                    </div>
